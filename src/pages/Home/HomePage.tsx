...
export function HomePage({ setActiveTab, setActiveMode }: HomePageProps): React.ReactElement {
  ...
  return (
    <div className="flex flex-col gap-16 max-w-5xl mx-auto py-6 relative">
      <section className="relative overflow-hidden bg-card border border-border/30 p-8 md:p-12 transition-all duration-500 ease-out rounded-3xl flex flex-col lg:flex-row items-center justify-between gap-8 z-10">
        <div className="flex-1 text-left space-y-6">
          <span className="inline-flex items-center gap-2 rounded-full border border-accent bg-accent/5 px-3 py-1 text-xs font-bold text-accent">
        ...
        <div className="flex-grow lg:flex-1 flex justify-center relative w-full max-w-md lg:max-w-none">
          <div className="relative w-80 h-80 md:w-96 md:h-96 flex items-center justify-center">
            <div className="absolute -top-4 flex gap-3 justify-center w-full">
              <span className="w-1.5 h-12 bg-accent/25 rounded-full animate-steam" style={{ animationDelay: "0.1s" }} />
              <span className="w-2 h-16 bg-accent/25 rounded-full animate-steam" style={{ animationDelay: "0.5s" }} />
              <span className="w-1.5 h-10 bg-accent/25 rounded-full animate-steam" style={{ animationDelay: "0.9s" }} />
            </div>
            <span className="absolute inset-0 rounded-full bg-accent/5 blur-3xl animate-pulse" />
            ...
            >
              <span className="absolute top-3 w-4 h-4 rounded-full bg-accent/70 shadow-sm" />
              <span className="absolute bottom-3 w-3 h-3 rounded-full bg-primary/50" />
              <span className="absolute right-6 w-2 h-2 rounded-full bg-muted-foreground/40" />
            </div>
            <div className="absolute w-44 h-44 md:w-52 md:h-52 bg-card border border-border flex flex-col items-center justify-center transition-all duration-500 hover:rotate-3 rounded-3xl shadow-sm hover:-translate-y-0.5 hover:shadow-md">
              ...
              <span className="absolute bottom-5 flex items-center gap-2 text-xs md:text-sm font-extrabold text-accent">
                ...
                >
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <span className="p-3 border border-border/10 rounded-xl bg-card/85 text-primary shadow-xs">
                    ...
                    <div className="space-y-2">
                      ...
                      <time className="text-2xl font-black text-primary">{t(mode.durationDisplay)}</time>
      ...
      <section className="bg-card border border-border/30 p-8 md:p-12 space-y-8 transition-all duration-500 ease-out rounded-3xl shadow-sm hover:shadow-md">
        ...
        <ol className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          <li className="flex flex-col gap-3 relative">
            <span className="flex h-12 w-12 items-center justify-center border border-border bg-secondary shadow-xs text-lg font-black text-accent rounded-xl">
              1
            </span>
