    ...
    <div className="flex flex-col gap-24 max-w-4xl mx-auto py-24 text-left relative z-10">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-24 relative items-start">
        <article className="space-y-8 relative">
          <span className="typography-utility text-[10px] text-muted-foreground/60 select-none tracking-widest font-mono block">
          ...
          <div className="space-y-6">
            ...
            <blockquote className="border-l-2 border-accent pl-6 py-2 bg-transparent rounded-none my-4">
        ...
        <span className="hidden md:block absolute left-1/2 top-0 bottom-0 w-[1px] bg-border/25 -translate-x-1/2" />
      ...
      <section className="space-y-12 border-t border-dashed border-border/40 pt-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center items-stretch">
          <article className="p-6 bg-transparent border-none space-y-4 flex flex-col justify-start">
          ...
          <article className="p-8 bg-accent/5 border border-accent/20 rounded-organic space-y-4 flex flex-col justify-center relative overflow-hidden group shadow-xs">
            <span className="relative h-16 w-full flex items-center justify-center mb-2 select-none pointer-events-none">
              <span className="absolute inset-0 flex items-center justify-center opacity-25 text-accent">
                <svg
                  className="w-28 h-12"
                  fill="none"
                  stroke="currentColor"
              ...
              <span className="relative z-10 text-accent bg-background/60 backdrop-blur-xs p-3 rounded-full border border-accent/20 shadow-2xs transition-transform duration-500 group-hover:scale-110">
        ...
        <section className="max-w-4xl mx-auto pt-16 border-t border-dashed border-border/40 relative">
          ...
          <ol className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 relative">
            <span className="hidden md:block absolute top-6 left-[10%] right-[10%] h-[1px] border-t border-dashed border-accent/20 z-0" />

            <li className="space-y-4 text-center md:text-left relative z-10">
